...
## 역곡역 매장
Store.create(user_id: '1',station_id: '1', store_name: '리얼프라이',store_address: '경기 부천시 괴안동 115-6', store_seat_total: 50)
Store.create(user_id: '2',station_id: '1',store_name: '미쳐버린 파닭',store_address: '경기 부천시 역곡동 35-14', store_seat_total: 50)
...
## 온수역 매장
Store.create(user_id: '3',station_id: '2',store_name: '터프네 이모',store_address: '서울 구로구 온수동 55-4', store_seat_total: 50)
Store.create(user_id: '4',station_id: '2',store_name: '호프할래',store_address: '서울 구로구 온수동 51-4', store_seat_total: 50)
Store.create(user_id: '5',station_id: '2',store_name: '바베큐 보스 치킨',store_address: '서울 구로구 온수동 52-1', store_seat_total: 50)
